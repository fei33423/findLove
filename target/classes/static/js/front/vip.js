$(function () {
    ...
    $("#starBuyWay").change(function () {
        if ($(this).val() == "牵手币") {
            ...
            if ($("#starBuyDay").val() < 0) {
                ...
                $("#starBuyMoney").val(($("#starBuyDay").val() * 10));
            }
        } else {
            $("#moneyPayStar").show();
            ...
            {
                $("#starBuyMoney").val("￥" + ($("#starBuyDay").val() * 10.1).toFixed(2));
            }
        }
    });
    ...
    $("#starBuyDay").change(function () {
        if ($("#starBuyWay").val() == "支付宝") {
            ...
            //计算购买金额
            $("#starBuyMoney").val("￥" + ($(this).val() * 10.1).toFixed(2));
        } else {
            if ($(this).val() < 0) {
                $("#starBuyMoney").val('');
                return;
    ...
    $("#starSubmit").click(function () {
        if ($("#starBuyWay").val() == "牵手币") {
            var starBuyMoney=$("#starBuyDay").val()*10;
        } else {
            starBuyMoney=$("#starBuyDay").val()*10.1;
        }
        $.ajax({
